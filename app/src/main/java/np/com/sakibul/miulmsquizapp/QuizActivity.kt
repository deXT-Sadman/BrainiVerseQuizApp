...
import np.com.sakibul.miulmsquizapp.databinding.ActivityQuizBinding
import np.com.sakibul.miulmsquizapp.databinding.ScoreDialogBinding
            ...
            database.child("users").child(userId).child("score").setValue(score)
                .addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        Log.i("Firebase", "Score updated successfully")
                    } else {
                        Log.e("Firebase", "Failed to update score: ${task.exception?.message}")
                    }
                }
        } else {
